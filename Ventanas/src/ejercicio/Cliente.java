...
public class Cliente extends Persona{
    ...
    public Cliente(int idCliente, String habitual, int cantcomp, double presupuesto, String nombre, String apellido, String dni, String email, String numero_telefono) {
